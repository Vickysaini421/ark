...
- What runtimes/dependencies are needed and available (detect from the system — e.g. check `which python3`, `which node`, `which cargo`, etc. Use what's actually in PATH, don't assume)
